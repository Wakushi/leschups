            ...
            <div className="space-y-6">
              <div className="mb-2">
                <div className="flex items-center gap-2 text-xl">
                  <Link
                    href="tel:0611846005"
                    className="flex items-center gap-2 text-bold text-center drop-shadow-xl text-white transition-colors"
                  >
                ...
                <div className="flex items-center gap-2 text-xl mt-4">
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 text-bold text-center drop-shadow-xl text-white transition-colors"
                  >
